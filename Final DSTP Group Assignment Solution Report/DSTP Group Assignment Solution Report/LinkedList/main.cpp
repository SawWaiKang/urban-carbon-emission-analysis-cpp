...
LinkedList cityAArray;
LinkedList cityBArray;
LinkedList cityCArray;
...
void displayAgeGroupReport(LinkedList& dataset, const string& datasetName);
...
LinkedList* getDatasetByChoice(int choice);
string getDatasetName(int choice);

void displayAllRecords(LinkedList& dataset, int datasetChoice);

void sortByAge(LinkedList& dataset, const string& datasetName);
void sortByDistance(LinkedList& dataset, const string& datasetName);
void sortByEmission(LinkedList& dataset, const string& datasetName);

void searchByAgeGroup(LinkedList& dataset, const string& datasetName);
void searchByTransportMode(LinkedList& dataset, const string& datasetName);
void searchByDistance(LinkedList& dataset, const string& datasetName);

void totalEmissionPerCity();
void emissionByTransportMode();
void compareEmissionByCity();

void mostPreferredTransport(LinkedList& dataset, const string& datasetName);
void totalEmissionByAgeGroup(LinkedList& dataset, const string& datasetName);
void averageEmissionPerResident(LinkedList& dataset, const string& datasetName);
    ...
    while (running) {
        ...
        switch (mainChoice) {
            case 1: {
                ...
                LinkedList* dataset = getDatasetByChoice(datasetChoice);
...
void displayMainMenu() {
    system("cls");  
    string header = "URBAN CARBON EMISSION ANALYSIS SYSTEM (LinkedList)";
    printHeader(header);
